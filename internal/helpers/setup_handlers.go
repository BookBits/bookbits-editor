...
func SetupHandlers(app *fiber.App) {
	...
	app.Get("/app/search", handlers.Search, middlewares.AuthMiddleware, middlewares.AuthOnlyRoute)
	...
	app.Get("/app/projects/files/:fid/view", handlers.ViewFile, middlewares.AuthMiddleware, middlewares.AuthOnlyRoute)
